...
function DangNhap(){
    ...
    <form id="frmlogin" className="col-7 m-auto mt-3 border border-danger">
        ...
        <div className="m-3">Tên đăng nhập 
         <input className="form-control shadow-none border-danger-subtle" type="text" ref={emailRef} />
        </div>
        <div className="m-3">Mật khẩu 
         <input className="form-control shadow-none border-danger-subtle" type="password" ref={pwRef}/>
        </div>
        <div className="m-3">
            <button  onClick={()=>submitDuLieu()}  type="button"  className="btn btn-danger px-3">Đăng nhập</button>
        </div>
    </form>
    );//return
    }
